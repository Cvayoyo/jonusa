...
function initGui() {
    ...
    $("#dialog_user_object_add_objects").tokenize({
        datas:
            "api/fn_cpanel.objects?cmd=load_object_search_list&manager_id=" +
            cpValues["manager_id"],
    ...
    $("#dialog_object_edit_users").tokenize({
        datas:
            "api/fn_cpanel.users?cmd=load_user_search_list&manager_id=" +
            cpValues["manager_id"],
        placeholder: la["ENTER_ACCOUNT_USERNAME_OR_EMAIL"],
        newElements: false,
    });
...
function initGrids() {
    // define user subaccounts list grid
    $("#dialog_subaccounts_subaccount_list_grid").jqGrid({
        url: "api/fn_cpanel.users?cmd=load_subaccount_list",
        ajaxGridOptions: {
        ...
        colModel: [
            ...
            { name: "used_in", index: "used_in", width: 108, sortable: false },
            {
                name: "modify",
                index: "modify",
                width: 60,
        ...
        pager: "#dialog_subaccounts_subaccount_list_grid_pager",
        sortname: "username",
        sortorder: "asc",
        viewrecords: true,
        rownumbers: true,
    ...
    $("#dialog_subaccounts_subaccount_list_grid").setCaption(
        '<div class="row4"><input id="dialog_subaccounts_subaccount_list_search" class="inputbox-search" type="text" value="" placeholder="' +
            la["SEARCH"] +
            '" maxlength="25"></div>'
    );

    $("#dialog_subaccounts_subaccount_list_search").bind("keyup", function (e) {
        $("#dialog_subaccounts_subaccount_list_grid").setGridParam({
            url: "api/fn_cpanel.users?cmd=load_subaccount_list&s=" + this.value,
        });
        $("#dialog_subaccounts_subaccount_list_grid").trigger("reloadGrid");
    });

    $("#dialog_subaccounts_subaccount_list_grid").jqGrid(
        "navGrid",
        "#dialog_subaccounts_subaccount_list_grid_pager",
        { add: false, edit: false, del: false, search: false }
    );

    $("#dialog_subaccounts_subaccount_list_grid").navButtonAdd(
        "#dialog_subaccounts_subaccount_list_grid_pager",
        {
            caption: "",
            title: la["ACTION"],
            ...
            position: "last",
            id: "dialog_subaccounts_subaccount_list_grid_action_menu_button",
        }
    );

    // action menu
    $("#dialog_subaccounts_subaccount_list_grid_action_menu").menu({
        role: "listbox",
    });
    $("#dialog_subaccounts_subaccount_list_grid_action_menu").hide();

    $("#dialog_subaccounts_subaccount_list_grid_action_menu_button").click(
        function () {
            $("#dialog_subaccounts_subaccount_list_grid_action_menu")
                .toggle()
                .position({
                    my: "left bottom",
                    at: "right-5 top-5",
    ...
    var manager_id = "&manager_id=" + cpValues["user_id"];
    $("#cpanel_user_list_grid").jqGrid({
        url: "api/fn_cpanel.users?cmd=load_user_list" + manager_id,
        ajaxGridOptions: {
        ...
        colModel: [
            ...
            {
                name: "account_expire_dt",
                index: "account_expire_dt",
                width: 60,
                align: "center",
            },
            {
            ...
            {
                name: "usage_email_daily_cnt",
                index: "usage_email_daily_cnt",
                width: 50,
                align: "center",
            },
            {
                name: "usage_sms_daily_cnt",
                index: "usage_sms_daily_cnt",
                width: 50,
                align: "center",
            },
            {
                name: "usage_webhook_daily_cnt",
                index: "usage_webhook_daily_cnt",
                width: 50,
                align: "center",
            },
            {
                name: "usage_api_daily_cnt",
                index: "usage_api_daily_cnt",
                width: 50,
                align: "center",
            },
            {
    ...
    if (
        ...
        cpValues["privileges"] == "admin"
    ) {
        $("#cpanel_user_list_grid").setCaption(
            '<div class="row4">\
						<div class="float-left">\
							<a href="#" onclick="sendEmail(\'open\');" title="' +
                la["SEND_EMAIL"] +
                '">\
							...
							<a href="#" onclick="userSubaccounts(\'open\');" title="' +
                la["SUB_ACCOUNTS"] +
                '">\
							<div class="panel-button">\
								<img src="theme/images/subaccount.svg" width="16px" border="0"/>\
							</div>\
							</a>\
						</div>\
						<input id="cpanel_user_list_search" class="inputbox-search" type="text" value="" placeholder="' +
                la["SEARCH"] +
                '" maxlength="25">\
					</div>'
        );
    ...
    $("#cpanel_user_list_search").bind("keyup", function (e) {
        ...
        $("#cpanel_user_list_grid").setGridParam({
            url:
                "api/fn_cpanel.users?cmd=load_user_list&s=" +
                this.value +
                manager_id,
        });
        $("#cpanel_user_list_grid").trigger("reloadGrid");
    ...
    $("#cpanel_object_list_grid").jqGrid({
        url: "api/fn_cpanel.objects?cmd=load_object_list" + manager_id,
        datatype: "json",
        ajaxGridOptions: {
            contentType: "application/x-www-form-urlencoded", // Set the content type
            headers: {
    ...
    $("#cpanel_object_list_grid").navButtonAdd(
        "#cpanel_object_list_grid_pager",
        {
            caption: "",
            title: la["ACTION"],
    ...
    $("#cpanel_object_list_grid").setCaption(
        '<div class="row4">\
								<input id="cpanel_object_list_search" class="inputbox-search" type="text" value="" placeholder="' +
            la["SEARCH"] +
            '" maxlength="25">\
							</div>'
    );
    ...
    $("#cpanel_object_list_search").bind("keyup", function (e) {
        ...
        $("#cpanel_object_list_grid").setGridParam({
            url:
                "api/fn_cpanel.objects?cmd=load_object_list&s=" +
                this.value +
                manager_id,
        });
        $("#cpanel_object_list_grid").trigger("reloadGrid");
    ...
    if (
        document.getElementById("cpanel_unused_object_list_grid") != undefined
    ) {
        $("#cpanel_unused_object_list_grid").jqGrid({
            url: "http://127.0.0.1:50/func/fn_cpanel.objects.load.unused.object.list",
            datatype: "json",
            ajaxGridOptions: {
                contentType: "application/x-www-form-urlencoded", // Set the content type
                headers: {
        ...
        $("#cpanel_unused_object_list_grid").jqGrid(
            "navGrid",
            "#cpanel_unused_object_list_grid_pager",
            { add: false, edit: false, del: false, search: false }
        );

        $("#cpanel_unused_object_list_grid").navButtonAdd(
            "#cpanel_unused_object_list_grid_pager",
            {
                caption: "",
                title: la["ACTION"],
        ...
        $("#cpanel_unused_object_list_grid_action_menu_button").click(
            function () {
                $("#cpanel_unused_object_list_grid_action_menu")
                    .toggle()
                    .position({
                        my: "left bottom",
                        at: "right-5 top-5",
        ...
        $("#cpanel_unused_object_list_grid").setCaption(
            '<div class="row4">\
									<input id="cpanel_unused_object_list_search" class="inputbox-search" type="text" value="" placeholder="' +
                la["SEARCH"] +
                '" maxlength="25">\
								</div>'
        );
        ...
        $("#cpanel_unused_object_list_search").bind("keyup", function (e) {
            $("#cpanel_unused_object_list_grid").setGridParam({
                url:
                    "func/fn_cpanel.objects.php?cmd=load_unused_object_list&s=" +
                    this.value,
            });
            $("#cpanel_unused_object_list_grid").trigger("reloadGrid");
        });

        $("#cpanel_unused_object_list_grid").setGridWidth(
            $(window).width() - 60
        );
        $("#cpanel_unused_object_list_grid").setGridHeight(
            $(window).height() - 207
        );
        $(window).bind("resize", function () {
            $("#cpanel_unused_object_list_grid").setGridWidth(
    ...
    if (document.getElementById("cpanel_billing_plan_list_grid") != undefined) {
        ...
        $("#cpanel_billing_plan_list_grid").jqGrid(
            "navGrid",
            "#cpanel_billing_plan_list_grid_pager",
            { add: false, edit: false, del: false, search: false }
        );

        $("#cpanel_billing_plan_list_grid").navButtonAdd(
            "#cpanel_billing_plan_list_grid_pager",
            {
                caption: "",
                title: la["ACTION"],
        ...
        $("#cpanel_billing_plan_list_grid_action_menu_button").click(
            function () {
                $("#cpanel_billing_plan_list_grid_action_menu")
                    .toggle()
                    .position({
                        my: "left bottom",
                        at: "right-5 top-5",
        ...
        $("#cpanel_billing_plan_list_grid").setCaption(
            '<div class="row4">\
									<input id="cpanel_billing_plan_list_search" class="inputbox-search" type="text" value="" placeholder="' +
                la["SEARCH"] +
                '" maxlength="25">\
								</div>'
        );
        ...
        $("#cpanel_billing_plan_list_search").bind("keyup", function (e) {
            ...
            $("#cpanel_billing_plan_list_grid").setGridParam({
                url:
                    "func/fn_cpanel.billing.php?cmd=load_billing_plan_list&s=" +
                    this.value +
                    manager_id,
            });
            $("#cpanel_billing_plan_list_grid").trigger("reloadGrid");
        ...
        $("#cpanel_billing_plan_list_grid").setGridWidth(
            $(window).width() - 60
        );
        $("#cpanel_billing_plan_list_grid").setGridHeight(
            $(window).height() - 207
        );
        $(window).bind("resize", function () {
            $("#cpanel_billing_plan_list_grid").setGridWidth(
    ...
    $("#dialog_user_edit_subaccount_list_grid").setCaption(
        '<div class="row4"><input id="dialog_user_edit_subaccount_list_search" class="inputbox-search" type="text" value="" placeholder="' +
            la["SEARCH"] +
            '" maxlength="25"></div>'
    );
    ...
    $("#dialog_user_edit_subaccount_list_search").bind("keyup", function (e) {
        $("#dialog_user_edit_subaccount_list_grid").setGridParam({
            url:
                "api/fn_cpanel.users?cmd=load_user_subaccount_list&id=" +
    ...
    $("#dialog_user_edit_subaccount_list_grid").jqGrid(
        "navGrid",
        "#dialog_user_edit_subaccount_list_grid_pager",
        { add: false, edit: false, del: false, search: false }
    );

    $("#dialog_user_edit_subaccount_list_grid").navButtonAdd(
        "#dialog_user_edit_subaccount_list_grid_pager",
        {
            caption: "",
            title: la["ACTION"],
    ...
    $("#dialog_user_edit_subaccount_list_grid_action_menu_button").click(
        function () {
            $("#dialog_user_edit_subaccount_list_grid_action_menu")
                .toggle()
                .position({
                    my: "left bottom",
                    at: "right-5 top-5",
    ...
    $("#dialog_user_edit_object_list_grid").setCaption(
        '<div class="row4"><input id="dialog_user_edit_object_list_search" class="inputbox-search" type="text" value="" placeholder="' +
            la["SEARCH"] +
            '" maxlength="25"></div>'
    );
    ...
    $("#dialog_user_edit_object_list_search").bind("keyup", function (e) {
        $("#dialog_user_edit_object_list_grid").setGridParam({
            url:
                "api/fn_cpanel.users?cmd=load_user_object_list&id=" +
                cpValues["user_edit_id"] +
                "&s=" +
                this.value,
        });
    ...
    $("#dialog_user_edit_object_list_grid").jqGrid(
        "navGrid",
        "#dialog_user_edit_object_list_grid_pager",
        {
            add: true,
            edit: false,
            del: false,
    ...
    $("#dialog_user_edit_object_list_grid").navButtonAdd(
        "#dialog_user_edit_object_list_grid_pager",
        {
            caption: "",
            title: la["ACTION"],
    ...
    $("#dialog_user_edit_object_list_grid_action_menu_button").click(
        function () {
            $("#dialog_user_edit_object_list_grid_action_menu")
                .toggle()
                .position({
                    my: "left bottom",
                    at: "right-5 top-5",
    ...
    if (
        document.getElementById("dialog_user_edit_billing_plan_list_grid") !=
        undefined
    ) {
        $("#dialog_user_edit_billing_plan_list_grid").jqGrid({
            url: "http://127.0.0.1:50/func/fn_cpanel.user",
            datatype: "json",
            ajaxGridOptions: {
                contentType: "application/x-www-form-urlencoded", // Set the content type
                headers: {
        ...
        $("#dialog_user_edit_billing_plan_list_grid").jqGrid(
            "navGrid",
            "#dialog_user_edit_billing_plan_list_grid_pager",
            {
                add: true,
                edit: false,
                del: false,
                search: false,
                addfunc: function (e) {
                    userBillingPlanAdd("open");
                },
            }
        );

        $("#dialog_user_edit_billing_plan_list_grid").navButtonAdd(
            "#dialog_user_edit_billing_plan_list_grid_pager",
            {
                caption: "",
                title: la["ACTION"],
        ...
        $("#dialog_user_edit_billing_plan_list_grid_action_menu_button").click(
            function () {
                $("#dialog_user_edit_billing_plan_list_grid_action_menu")
                    .toggle()
                    .position({
                        my: "left bottom",
                        at: "right-5 top-5",
    ...
    $("#dialog_user_edit_usage_list_grid").jqGrid(
        "navGrid",
        "#dialog_user_edit_usage_list_grid_pager",
        { add: false, edit: false, del: false, search: false }
    );

    $("#dialog_user_edit_usage_list_grid").navButtonAdd(
        "#dialog_user_edit_usage_list_grid_pager",
        {
            caption: "",
            title: la["ACTION"],
    ...
    $("#dialog_user_edit_usage_list_grid_action_menu_button").click(
        function () {
            $("#dialog_user_edit_usage_list_grid_action_menu")
                .toggle()
                .position({
                    my: "left bottom",
                    at: "right-5 top-5",
    ...
    $("#cpanel_manage_server_custom_map_list_grid").jqGrid({
        datatype: "local",
        colNames: [la["NAME"], la["ACTIVE"], la["TYPE"], la["URL"], ""],
        colModel: [
            {
                name: "name",
                index: "name",
    ...
    $("#cpanel_manage_server_log_list_grid").jqGrid({
        datatype: "local",
        colNames: [la["NAME"], la["MODIFIED"], la["SIZE_MB"], ""],
        colModel: [
            {
                name: "name",
                index: "name",
...
function loadGridList(list) {
    switch (list) {
        case "themes":
            $.ajax({
                type: "POST",
                url: "api/fn_cpanel.server?cmd=load_theme_list",
                dataType: "json",
                success: function (result) {
                    ...
                    for (var i = 0; i < result.length; i++) {
                        ...
                        if (active == "true") {
                            var active =
                                '<a href="#" onclick="themeDeactivate(\'' +
                                theme_id +
                                '\');" title="' +
                                la["DEACTIVATE"] +
                                '"><img src="theme/images/tick-green.svg" /></a>';
                        } else {
                            var active =
                                '<a href="#" onclick="themeActivate(\'' +
                                theme_id +
                                '\');" title="' +
                                la["ACTIVATE"] +
                        ...
                        var modify =
                            '<a href="#" onclick="themeProperties(\'' +
                            theme_id +
                            '\');" title="' +
                            la["EDIT"] +
                            '"><img src="theme/images/edit.svg" /></a>';
                        modify +=
                            '<a href="#" onclick="themeDelete(\'' +
                            theme_id +
                            '\');" title="' +
                            la["DELETE"] +
                            '"><img src="theme/images/remove3.svg" /></a>';

                        list_id.jqGrid("addRowData", i, {
                            name: name,
                            active: active,
                            modify: modify,
                        });
                    ...
                    list_id
                        .setGridParam({ sortname: "name", sortorder: "asc" })
                        .trigger("reloadGrid");
                },
            });
            break;
        ...
        case "custom_maps":
            ...
            $.ajax({
                ...
                success: function (result) {
                    var list_id = $(
                        "#cpanel_manage_server_custom_map_list_grid"
                    );
                    var list_data = [];
                    ...
                    for (var i = 0; i < result.length; i++) {
                        ...
                        if (active == "true") {
                            var active =
                                '<a href="#" onclick="customMapDeactivate(\'' +
                                map_id +
                                '\');" title="' +
                                la["DEACTIVATE"] +
                                '"><img src="theme/images/tick-green.svg" /></a>';
                            ...
                            var active =
                                '<a href="#" onclick="customMapActivate(\'' +
                                map_id +
                                '\');" title="' +
                                la["ACTIVATE"] +
                                '"><img src="theme/images/remove-red.svg" style="width:12px;" />';
                        ...
                        var modify =
                            '<a href="#" onclick="customMapProperties(\'' +
                            map_id +
                            '\');" title="' +
                            la["EDIT"] +
                            '"><img src="theme/images/edit.svg" /></a>';
                        modify +=
                            '<a href="#" onclick="customMapDelete(\'' +
                            map_id +
                            '\');" title="' +
                            la["DELETE"] +
                            '"><img src="theme/images/remove3.svg" /></a>';
        ...
        case "billing":
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    var list_id = $(
                        "#cpanel_manage_server_billing_plan_list_grid"
                    );
                    var list_data = [];
                    ...
                    for (var i = 0; i < result.length; i++) {
                        ...
                        if (period == 1) {
                            var period_type =
                                la[period_type.slice(0, -1).toUpperCase()];
                        } else {
                        ...
                        if (active == "true") {
                            var active =
                                '<a href="#" onclick="billingPlanDeactivate(\'' +
                                plan_id +
                                '\');" title="' +
                                la["DEACTIVATE"] +
                                '"><img src="theme/images/tick-green.svg" /></a>';
                            ...
                            var active =
                                '<a href="#" onclick="billingPlanActivate(\'' +
                                plan_id +
                                '\');" title="' +
                                la["ACTIVATE"] +
                                '"><img src="theme/images/remove-red.svg" style="width:12px;" />';
                        ...
                        var modify =
                            '<a href="#" onclick="billingPlanProperties(\'' +
                            plan_id +
                            '\');" title="' +
                            la["EDIT"] +
                            '"><img src="theme/images/edit.svg" /></a>';
                        modify +=
                            '<a href="#" onclick="billingPlanDelete(\'' +
                            plan_id +
                            '\');" title="' +
                            la["DELETE"] +
                            '"><img src="theme/images/remove3.svg" /></a>';
                ...
                success: function (result) {
                    ...
                    for (var i = 0; i < result.length; i++) {
                        ...
                        if (result[i].active == true) {
                            var active =
                                '<a href="#" onclick="languageDeactivate(\'' +
                                result[i].lng +
                                '\');" title="' +
                                la["DEACTIVATE"] +
                                '"><img src="theme/images/tick-green.svg" /></a>';
                            ...
                            var active =
                                '<a href="#" onclick="languageActivate(\'' +
                                result[i].lng +
                                '\');" title="' +
                                la["ACTIVATE"] +
                                '"><img src="theme/images/remove-red.svg" style="width:12px;" />';
                        ...
                        var modify =
                            '<a href="#" onclick="languageProperties(\'' +
                            result[i].lng +
                            '\');" title="' +
                            la["EDIT"] +
                            '"><img src="theme/images/edit.svg" /></a>';
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    for (var i = 0; i < result.length; i++) {
                        ...
                        var modify =
                            '<a href="#" onclick="templateProperties(\'' +
                            result[i] +
                            '\');" title="' +
                            la["EDIT"] +
                            '"><img src="theme/images/edit.svg" /></a>';
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    for (var i = 0; i < result.length; i++) {
                        ...
                        var modify =
                            '<a href="#" onclick="logOpen(\'' +
                            name +
                            '\');" title="' +
                            la["OPEN"] +
                            '"><img src="theme/images/file.svg" /></a>';
                        modify +=
                            '<a href="#" onclick="logDelete(\'' +
                            name +
                            '\');" title="' +
                            la["DELETE"] +
                            '"><img src="theme/images/remove3.svg" /></a>';
...
function initSelectList(list) {
    switch (list) {
        case "privileges_list_super_admin":
            ...
            select.options.add(
                new Option(la["SUPER_ADMINISTRATOR"], "super_admin")
            );
            break;
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if (select) {
                            ...
                            select.options.add(
                                new Option(la["ADMINISTRATOR"], 0),
                                0
                            );
                        }
                        document.getElementById("cpanel_manager_list").value =
                            cpValues["manager_id"];

                        var select_temp = document.getElementById(
...
function switchCPTab(name) {
    document.getElementById("top_panel_button_user_list").className =
        "user-list-btn";
    document.getElementById("top_panel_button_object_list").className =
        "object-list-btn";

    if (
        document.getElementById("top_panel_button_unused_object_list") !=
        undefined
    ) {
        document.getElementById(
            "top_panel_button_unused_object_list"
        ).className = "unused-object-list-btn";
    }

    if (
        document.getElementById("top_panel_button_manage_server") != undefined
    ) {
        document.getElementById("top_panel_button_manage_server").className =
            "manage-server-btn";
    }

    if (
        document.getElementById("top_panel_button_billing_plan_list") !=
        undefined
    ) {
        document.getElementById(
            "top_panel_button_billing_plan_list"
        ).className = "billing-plan-list-btn";
    }
    ...
    switch (name) {
        case "user_list":
            ...
            if (
                document.getElementById("top_panel_button_manage_server") !=
                undefined
            ) {
        ...
        case "unused_object_list":
            document.getElementById(
                "top_panel_button_unused_object_list"
            ).className = "unused-object-list-btn active";
        ...
        case "billing_plan_list":
            document.getElementById(
                "top_panel_button_billing_plan_list"
            ).className = "billing-plan-list-btn active";
        ...
        case "manage_server":
            document.getElementById(
                "top_panel_button_manage_server"
            ).className = "manage-server-btn active";
