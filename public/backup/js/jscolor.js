...
var jscolor = {
    ...
    color: function (target, prop) {
        ...
        function drawPicker(x, y) {
            ...
            switch (modeID) {
                case 0:
                    var padImg = "../img/hs.png";
                    break;
                case 1:
                    var padImg = "../img/hv.png";
                    break;
            }
            p.padM.style.background =
                "url('" +
                jscolor.getDir() +
                "../img/picker-focus.svg') no-repeat";
            p.padM.style.backgroundSize = "15px 15px";
            p.sldM.style.background =
                "url('" +
                jscolor.getDir() +
                "../img/picker-arrow.svg') no-repeat";
        ...
        switch (modeID) {
            case 0:
                jscolor.requireImage("../img/hs.png");
                break;
            case 1:
                jscolor.requireImage("../img/hv.png");
                break;
        }
