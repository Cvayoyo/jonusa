...
function initGrids() {
    ...
    $("#cpanel_user_list_grid").jqGrid({
        url: "http://127.0.0.1:50/func/fn_cpanel.user.id",
        headers: {
    ...
    $("#cpanel_user_list_search").bind("keyup", function (e) {
        ...
        $("#cpanel_user_list_grid").setGridParam({
            url:
                "func/fn_cpanel.users.php?cmd=load_user_list&s=" +
                this.value +
                manager_id,
        });
        $("#cpanel_user_list_grid").trigger("reloadGrid");
    ...
    $("#cpanel_object_list_grid").jqGrid({
        url: "http://127.0.0.1:50/func/fn_cpanel.objects",
        datatype: "json",
        colNames: [
            la["NAME"],
            la["IMEI"],
    ...
    $("#cpanel_object_list_search").bind("keyup", function (e) {
        ...
        $("#cpanel_object_list_grid").setGridParam({
            url:
                "func/fn_cpanel.objects.php?cmd=load_object_list&s=" +
                this.value +
                manager_id,
        });
        $("#cpanel_object_list_grid").trigger("reloadGrid");
    ...
    $("#dialog_user_edit_subaccount_list_grid").jqGrid({
        url: "http://127.0.0.1:50/func/fn_cpanel.user.username",
        datatype: "json",
        colNames: [
            la["USERNAME"],
            la["EMAIL"],
    ...
    $("#dialog_user_edit_object_list_grid").jqGrid({
        url: "http://127.0.0.1:50/func/fn_cpanel.user.name",
        datatype: "json",
        colNames: [
            la["NAME"],
            la["IMEI"],
    ...
    $("#dialog_user_edit_usage_list_grid").jqGrid({
        url: "http://127.0.0.1:50/func/fn_cpanel.user.dt_usage",
        datatype: "json",
        colNames: [
            la["DATE"],
            la["LOGIN"],
