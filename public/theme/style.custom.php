...
.menu.ui-menu .first-item {
    border-top: 3px solid #D92114;
}

#cpanel_user_list, #cpanel_object_list, #cpanel_unused_object_list, #cpanel_billing_plan_list, #cpanel_manage_server {
    border-top-color: #D92114;
}
...
#top_panel .user-btn span, #top_panel .user-list-btn span, #top_panel .object-list-btn span, #top_panel .billing-plan-list-btn span, #top_panel .unused-object-list-btn span {
    color: #808080;
}
